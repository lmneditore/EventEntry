...
If ($validact)
{
echo ("<table bgcolor=\"#FEFCD8\" border=1 bordercolor=\"#FEFCD8\" align=\"center\" width=\"365\"><TH class=\"searchhdr\"> Current Shows for</font><TH>\n");
...
If ($Date1==($thisrow["EventDate"]))/*Start Date Check Loop*/
{
   ...
   printf("<tr><td class=\"venue\"><a href=\"http://www.louisvillemusicnews.net/lmn/lmhdr.php?thisid=10&thiseventMainEVID=%s\">%s</a> </td></td></tr>\n",$thisrow["MainEVID"],$thisrow["VenueName"]);
			$Venue1=($thisrow["VenueName"]);
...
ELSE //.End of Is Valid Venue
{
echo "<table bgcolor=\"#FEFCD8\" border=1 bordercolor=\"#FEFCD8\" align=\"center\" width=\"365\">";
ECHO "<tr><td class=\"act\">You are not authorized to access this page.</td></tr>";
ECHO "<tr><td class=\"act\">";
?><button OnClick="parent.location='http://www.louisvillemusicnews.net/lmn/members/lmlogout.php'" style="background-color: grey">Click Here</button></td></tr>
<?}?>
</table>
