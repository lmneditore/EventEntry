...
ELSE
  ...
  // if the user has just tried to log in
       $connection4 = @mysql_connect("louisvillemusicnews.ipowermysql.com", "louisvil_tech2", "m00seipy") or die("couldn't connect");
...
return;
       ...
       displayadminheader();
           ...
           {
              echo "  <form method=\"POST\" action=\"lxmxaxdxmxixnxlxoxgxixn.php\">";
        ...
        echo "</Form>";
           ...
           echo "  <form method=\"get\" action=\"lxmxaxdxmxixnxlxoxgxixn.php\">";
