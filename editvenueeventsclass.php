    ...
    function displayvenueevents($venueid, $from, $to)
    {
          $this->lm_connection("louisvil_louisvillemusiccom");
            ...
            Do
            {
                ...
                $thisdate=($MainEVID==$MainEVID1 ? "" : "<div class=\"venueeventdate\">$FDate<a href=\"http://www.louisvillemusicnews.net/lmn/evententry/index.php?_action=EditThisEvent&MainEVID=".$MainEVID."\" OnMouseOver=\"window.status='".$Fdate."'\"; return true\"><span style=\"font-size: 8pt; font-variant: italic; color: white; \">&nbsp;&nbsp;...<I>MORE</I></span></a></div>"); 
               $display .= $thisdate;
